  ...
  return (
    <div className="h-screen w-screen flex items-center justify-center px-4"
      ...
      <div className="fixed top-0 right-0 w-96 h-96 pointer-events-none"
        style={{ background: "radial-gradient(circle at 80% 20%, hsl(var(--p) / 0.08), transparent 60%)" }} />

      <div className="w-full max-w-sm">
        {/* Logo */}
        <div className="flex flex-col items-center mb-8">
          <div className="w-12 h-12 rounded-2xl flex items-center justify-center mb-4"
            style={{ background: "hsl(var(--p) / 0.12)", border: "1px solid hsl(var(--p) / 0.25)",
              boxShadow: "0 0 24px hsl(var(--p) / 0.1)" }}>
            <Lock size={20} style={{ color: "hsl(var(--p))" }} />
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button type="submit" disabled={loading}
              ...
              style={{ background: "linear-gradient(135deg,hsl(var(--p)),hsl(var(--p2)))",
                color: "hsl(210 100% 4%)", boxShadow: "0 4px 20px hsl(var(--p) / 0.2)" }}>
